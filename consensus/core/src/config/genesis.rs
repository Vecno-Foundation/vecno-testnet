...
pub const GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        0x00, 0x0b, 0xd2, 0x4d, 0x26, 0x31, 0xcd, 0x96, 0xf7, 0x2c, 0xa1, 0xe7, 0x1d, 0x5f, 0x17, 0x4e,
        0x5e, 0xda, 0x38, 0xe8, 0xd7, 0xd6, 0xb0, 0xc2, 0x9a, 0xd1, 0xe2, 0x64, 0x74, 0x41, 0x57, 0x55
    ]),
    version: 0,
    hash_merkle_root: Hash::from_bytes([
        0x13, 0xde, 0x9e, 0x68, 0x89, 0x6a, 0xbe, 0x2d, 0xd1, 0xa8, 0xf8, 0x4d, 0x7f, 0x2a, 0x72, 0x04,
        0x70, 0x8c, 0xcb, 0x90, 0xb1, 0x6d, 0x4b, 0x6c, 0x86, 0x9a, 0x6b, 0xf6, 0x40, 0x88, 0xd5, 0xf4
    ]),
    utxo_commitment: Hash::from_bytes([
        0xed, 0x77, 0x97, 0x41, 0xf1, 0xdc, 0x03, 0x43, 0x63, 0xc2, 0x54, 0x56, 0x52, 0x9b, 0xdf, 0x8b,
        0xc6, 0xe1, 0xa2, 0xbf, 0x48, 0x92, 0x1f, 0x23, 0xdb, 0x34, 0xd4, 0x84, 0xcc, 0xe3, 0xd9, 0x7d
    ]),
    timestamp: 0xafb77296,
    bits: 0x1e007fff,
    nonce: 0x00000e81,
    daa_score: 0, // Uses genesis as checkpoint
    #[rustfmt::skip]
    coinbase_payload: &[
        ...
        0x01, // Varint
        0x00, // OP-FALSE
        0x65, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x6c, 0x79, 0x2c, 0x20, 0x66, 0x6f, 0x72, 0x20, 0x65, 0x76, 0x65, 0x72 // Eternally, for ever
    ],
};
